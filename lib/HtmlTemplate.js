...
const card = ((employee_data) => {
    ...
    switch (employee_data.getRole()) {
        case "Manager":
            cust_data = employee_data.getNumber();
            cust_label = "Office Phone: ";
            break;
        case "Engineer":
            cust_data = `<a href="https://github.com/${employee_data.getGitHub()}" target="_blank">${employee_data.getGitHub()}</a></p>`
            cust_label = "GitHub: ";
            break;
        case "Intern":
    ...
    <div class="employee_card">
        <div class="card_title">
            <img src="./assets/imgs/${employee_data.getRole().toLowerCase()}.svg" alt="">
            <div class="title_info">
                <h2>${employee_data.getName()}</h2>
                <h3>${employee_data.getRole()}</h3>            
            </div>
        </div>
        <div class="employee_data">
            <p><span>Id: </span>${employee_data.getId()}</p>
            <p><span>email: </span><a href="mailto: ${employee_data.getEmail()}">${employee_data.getEmail()}</a></p>
